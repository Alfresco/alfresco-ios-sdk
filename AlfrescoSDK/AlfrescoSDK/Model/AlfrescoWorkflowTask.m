...
{
    [aCoder encodeInteger:kWorkflowTaskModelVersion forKey:@"AlfrescoWorkflowTask"];
    ...
    [aCoder encodeObject:self.type forKey:kAlfrescoWorkflowPublicJSONName];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self)
    {
        //        NSInteger version = [aDecoder decodeIntegerForKey:@"AlfrescoWorkflowTask"];
        ...
        self.type = [aDecoder decodeObjectForKey:kAlfrescoWorkflowPublicJSONName];
