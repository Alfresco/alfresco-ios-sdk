...
{
    NSString *message = [aDecoder decodeObjectForKey:kAlfrescoJSONMessage];
    NSString *identifier = [aDecoder decodeObjectForKey:kAlfrescoJSONIdentifier];
    return [self initWithIdentifier:identifier message:message];
}
