...
@interface AlfrescoPublicAPICommentService ()
...
@implementation AlfrescoPublicAPICommentService
                      ...
                      completionBlock:(AlfrescoCommentCompletionBlock)completionBlock
{
    ...
    NSString *requestString = [kAlfrescoPublicAPIComments stringByReplacingOccurrencesOfString:kAlfrescoNodeRef
                         ...
                         completionBlock:(AlfrescoCommentCompletionBlock)completionBlock
{
    ...
    NSError *error = nil;
    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:commentDict options:0 error:&error];
    NSString *nodeRefString = [kAlfrescoPublicAPICommentForNode stringByReplacingOccurrencesOfString:kAlfrescoNodeRef
                                                                                         withString:[node.identifier stringByReplacingOccurrencesOfString:@"://" withString:@"/"]];
...
- (AlfrescoComment *) alfrescoCommentFromJSONData:(NSData *)data error:(NSError *__autoreleasing *)outError
{
    ...
    NSDictionary *jsonComment = [jsonCommentDict valueForKey:kAlfrescoPublicAPIJSONEntry];
    if (nil == jsonComment)
    {
        if (nil == *outError)
        {
