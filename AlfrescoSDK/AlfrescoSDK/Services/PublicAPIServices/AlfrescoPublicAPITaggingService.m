...
@interface AlfrescoPublicAPITaggingService ()
...
@implementation AlfrescoPublicAPITaggingService
...
{
    NSURL *url = [AlfrescoURLUtils buildURLFromBaseURLString:self.baseApiUrl extensionURL:kAlfrescoPublicAPITags listingContext:listingContext];
        ...
        else
        {
            ...
            if (usePaging)
            {
                ...
                if (tagArray && pagingInfo)
                {
                    ...
                    pagingResult = [[AlfrescoPagingResult alloc] initWithArray:tagArray hasMoreItems:hasMore totalItems:-1];
                }
                         ...
                         completionBlock:(AlfrescoArrayCompletionBlock)completionBlock
{
    ...
    NSString *requestString = [kAlfrescoPublicAPITagsForNode stringByReplacingOccurrencesOfString:kAlfrescoNodeRef
                         ...
                         completionBlock:(AlfrescoPagingResultCompletionBlock)completionBlock
{
    ...
    [self.session.networkProvider executeRequestWithURL:url
        ...
        else
        {
            ...
            {
                BOOL hasMore = [[pagingInfo valueForKeyPath:kAlfrescoPublicAPIJSONHasMoreItems] boolValue];
                int total = [[pagingInfo valueForKey:kAlfrescoPublicAPIJSONTotalItems] intValue];
