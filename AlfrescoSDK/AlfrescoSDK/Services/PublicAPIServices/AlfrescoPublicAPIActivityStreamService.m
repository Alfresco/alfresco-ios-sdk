...
@interface AlfrescoPublicAPIActivityStreamService ()
...
@implementation AlfrescoPublicAPIActivityStreamService
                                                         ...
                                                         usePaging:(BOOL)usePaging
{
    ...
    if (site)
    {
        NSString *peopleRefString = [kAlfrescoPublicAPIActivitiesForSite stringByReplacingOccurrencesOfString:kAlfrescoPersonId withString:self.session.personIdentifier];
        requestString = [peopleRefString stringByReplacingOccurrencesOfString:kAlfrescoSiteId withString:site.shortName];
    }
    else
    {
        requestString = [kAlfrescoPublicAPIActivities stringByReplacingOccurrencesOfString:kAlfrescoPersonId withString:self.session.personIdentifier];
    }
